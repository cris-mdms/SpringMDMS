...
public class LocoDataSlamJson {
	...
	public LocoDataSlamJson(Integer loco_no, String loco_owning_zone, String loco_owning_shed, String loco_type, String status, String loco_flag)
	{
	...
	public LocoDataSlamJson(Integer loco_no,  String loco_owning_shed , String loco_owning_sheds)
	{
	this.loco_no=loco_no;
	this.loco_owning_sheds=loco_owning_sheds;
	this.loco_owning_shed=loco_owning_shed;
	}
	public LocoDataSlamJson(Integer loco_no,  String loco_owning_shed , String loco_type, String loco_types)
	{
	this.loco_no=loco_no;
	this.loco_owning_shed=loco_owning_shed;
	this.loco_type=loco_type;
