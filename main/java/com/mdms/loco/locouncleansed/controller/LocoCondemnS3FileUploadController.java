...
//	  download from s3
	  @GetMapping(value= "/download")
		...
		public String uploadFileCondemn(@RequestPart(value = "approval_file") MultipartFile file2, @RequestParam("loco")String loco_no) throws IOException {
		//	logger.info("controller : CoachS3FileUploadController || Method : uploadFileCMM||")	;
			
			return this.amazonClient.uploadFileCondemn(file2,loco_no);
